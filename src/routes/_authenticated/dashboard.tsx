  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <Link
          to="/create"
          className="inline-flex items-center gap-2 self-start rounded-full bg-gradient-brand px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow-glow"
        >
      ...
      <GradientCard glow>
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            {yt.data.connection ? (
              <>
                ...
                <p className="text-xs text-muted-foreground">Connected · uploads enabled</p>
              </>
            ) : (
              <>
          ...
          <Link to="/settings" className="rounded-full border border-border px-3 py-1.5 text-xs">
            {yt.data.connection ? "Manage" : "Connect"}
          </Link>
        </div>
      </GradientCard>
        ...
        {active.length === 0 ? (
          <GradientCard>
            <p className="text-sm text-muted-foreground">
              No jobs running. Start a new clip generation to see progress here.
            </p>
          </GradientCard>
        ) : (
      ...
      <section>
        <div className="mb-3 flex items-center justify-between">
          ...
          <Link to="/history" className="text-xs text-brand-cyan">
            View all
          </Link>
        </div>
              ...
              <GradientCard key={u.id} className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-xs capitalize text-muted-foreground">
                      {u.status} {u.simulated ? "· simulated" : ""}
                    </p>
                  </div>
                </div>
              </GradientCard>
